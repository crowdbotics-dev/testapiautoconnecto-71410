...
## Project Structure
    ...
    ├── testapiautoconnecto_71410  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_71410`
...
2. Clone this repo and `cd testapiautoconnecto_71410`
